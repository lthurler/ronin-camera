    ...
    sendEmail = (e) => {
          e.preventDefault(),
               "" === contactName.value || "" === contactEmail.value || "" === contactProject.value
                    ? (contactMessage.classList.remove("color-blue"), contactMessage.classList.add("color-red"), (contactMessage.textContent = "Preencha todos os campos por favor"))
                    : (emailjs.sendForm("service_vhr6jx1", "template_b6335rj", "#contact-form", "zv4cDFntr7h6rvv2m").then(
                           () => {
